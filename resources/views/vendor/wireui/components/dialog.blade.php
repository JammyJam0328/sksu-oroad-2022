<div class="fixed inset-0 flex items-end overflow-y-auto sm:pt-16 justify-center {{ $align }} {{ $zIndex }}"
    ...
    <div class="w-full transition-all p-4 sm:max-w-lg" x-show="show" x-transition:enter="ease-out duration-300"
        ...
        <div class="relative shadow-md bg-white border border-green-600 dark:bg-secondary-800 rounded-xl space-y-4 p-4"
            :class="{
            ...
            <div class="grid grid-cols-1 gap-y-2 sm:gap-x-3 rounded-b-xl"
                :class="{
                    ...
                    'sm:p-4 sm:bg-secondary-100 sm:dark:bg-secondary-800 sm:grid-cols-none sm:flex sm:justify-end': style ===
                        'inline',
                }"
